...
alternate cover art, and now it's a collectable hobby.
...
showed up in my algorithm and I so I happily ordered the web-store exclusive
...
sometimes artists will add loose inserts or print onto the disc sleeve, but it's
not uncommon for them to be excluded. Other times, artists will simply print a
...
changes the taxonomy of his website. Secondly, he used a 
...
could also refresh this page and see the strings randomly re-arrange. This is
...
it on our site. I used OCR to scan the text; the results were okay, but not
perfect. I did my best to fact-check, but proofread it anyway. All I ask is that
you leave a link-back to my site._
