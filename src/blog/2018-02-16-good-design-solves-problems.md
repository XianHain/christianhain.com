...
brief: "Good design is about solving problems, regardless of the medium. American architect, Bertrand Goldberg, designed the Marina City in 1959 to address what he believed to be an issue with Chicago residents leaving the city to live in the suburbs. He dev..."
...
Situations like this occur all over the Web. Visually, things make sense because
designers have studied how to use text, color, shapes, and spacing to deliver a
message. They rely on the brain's ability to recognize patterns and previous
exposure to symbolism and relationships. ARIA attributes exist to explain all
these subconscious assumptions programmatically without sacrificing the
designer's intent. However, that doesn't mean they can be used to make up for
bad design or haphazard markup. ARIA attributes are expected to supplement
